...
## dbt-redshift 1.9.5+mdata2.1 - Jun 30, 2025

### Features

- Add Capability of submitting Python-based Models using AWS EMR Serverless Compute Application
- fix for s3 output path logging
